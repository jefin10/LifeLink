...
const HospitalPatients = () => {
    ...
    useEffect(() => {
        const fetchPatients = async () => {
            try {
                const response = await axios.get("http://localhost:5000/api/hospital/patients", {
                    withCredentials: true,
                });
    ...
    const handleAddPatient = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post("http://localhost:5000/api/hospital/addPatient", newPatient, {
                withCredentials: true,
            });
